 ...
 */
public class EastBehavior extends Behavior {
    public EastBehavior() {
        super();
            ...
            switch (this) {
                ...
                case TURN_CLOCKWISE:
                    return (State state) -> {
                        ...
                        listener.onOrientationChanged(Orientation.SOUTH);
                        listener.changeBehavior(SouthBehavior.getSouthBehavior());
                        System.out.format("%s: %s->%s\n", this, Orientation.EAST, Orientation.SOUTH);
                    };
            }
    ...
    public static HashMap<String, Action> getEastBehavior() {
