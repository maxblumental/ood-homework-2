 ...
 */
public class NorthBehavior extends Behavior {
    public NorthBehavior() {
        super();
            ...
            switch (this) {
                ...
                case TURN_CLOCKWISE:
                    return (State state) -> {
                        ...
                        listener.onOrientationChanged(Orientation.EAST);
                        listener.changeBehavior(EastBehavior.getEastBehavior());
                        System.out.format("%s: %s->%s\n", this, Orientation.NORTH, Orientation.EAST);
                    };
            }
    ...
    public static HashMap<String, Action> getNorthBehavior() {
